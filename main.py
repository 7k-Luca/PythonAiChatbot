...
responses = [
    "Music is so relaxing!", "Dogs are man's best friends!",
    "I know about a lot of books", "I like to play video games."
]
...
while user != "bye":
  ...
  for index in range(len(keywords)):
    ...
    if (keyword_found == False):
      new_keyword = input(
          "I'm not sure how to respond. What keyword should I respond to?")
